...
const CSS_VAR_MOBILE = '--kng-setting-mobile-breakpoint';
const CSS_VAR_TABLET = '--kng-setting-tablet-breakpoint';
...
export class BreakpointService {
  ...
  private initResizeListener(): void {
    ...
    merge(fromEvent(window, 'resize'), fromEvent(window, 'orientationchange'))
      .pipe(debounceTime(this.DEBOUNCE_MS), startWith(null), takeUntilDestroyed(this.destroyRef))
      .subscribe(() => {
